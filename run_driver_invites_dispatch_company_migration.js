// Script to run the dispatch company driver invites RLS migration
...
async function runMigration() {
  try {
    console.log('🚀 Running migration: Add Dispatch Company Support to Driver Invites RLS Policies');
    console.log('📄 File: supabase_migrations/041_add_dispatch_company_driver_invites_rls.sql\n');
    
    const sql = readFileSync('supabase_migrations/041_add_dispatch_company_driver_invites_rls.sql', 'utf8');
    ...
    console.error('\n💡 Please manually run: supabase_migrations/041_add_dispatch_company_driver_invites_rls.sql');
    process.exit(1);
  }
}
