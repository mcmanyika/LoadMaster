...
-- Superusers can view all profiles (cross-company admin dashboard)
...
-- Superusers can update any profile (e.g. status active/inactive)
...
-- Extend can_view_profile so superusers see all profiles consistently
